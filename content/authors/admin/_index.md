...
# Role/position
role: Research Statistician Developer
...
bio: My research interests include data analytics and missing data.
...
- icon: envelope
  icon_pack: fas
  link: 'mailto:michael.senter@sas.com'  # For a direct email link, use "mailto:test@example.org".
- icon: orcid
  icon_pack: fab
  link: https://orcid.org/0000-0002-2752-1688
- icon: google-scholar
  icon_pack: ai
...
- icon: linkedin
  icon_pack: fab
  link: https://www.linkedin.com/in/michaelsenter9a13a642/ 
#- icon: cv
#  icon_pack: ai
#  link: files/MichaelSenterCV.pdf
